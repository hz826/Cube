...
public class SDLActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		copyFilesFassets(this.getApplicationContext());
	...
	public void copyFilesFassets(Context context) {
		try {
			...
			for (String filename : files) if (filename.equals("yh_mono.ttf")) return ;
			//Toast.makeText(getApplicationContext(), "file not exist", Toast.LENGTH_SHORT).show();
			InputStream is = context.getAssets().open("yh_mono.ttf");
			FileOutputStream fos = this.openFileOutput("yh_mono.ttf", Context.MODE_PRIVATE);
			...
			//Toast.makeText(getApplicationContext(), "an error have been catched!", Toast.LENGTH_SHORT).show();
			e.printStackTrace();
			//如果捕捉到错误则通知UI线程
